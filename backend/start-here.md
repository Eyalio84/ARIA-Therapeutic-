...
| **services** | Business logic layer — game pipeline (interview → generator → runtime), therapy orchestration, NAI search, Gemini narrative, device state, persistence | 21 | [services/start-here.md](services/start-here.md) |
...
|---|---|---|---|
| **main.py** | FastAPI brand assistant server (port 8000) — initializes NAI, Persona, Introspection services and wires aria/products/kg routers | [main](backend.md#main) | main node |
